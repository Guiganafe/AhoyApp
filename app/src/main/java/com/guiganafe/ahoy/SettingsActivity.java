...
public class SettingsActivity extends AppCompatActivity
{
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE)
        {
            ...
            {
                loadingBar.setTitle("Enviando a foto");
                loadingBar.setMessage("Por favor, aguarde enquanto salvamos e atualizamos a sua foto de perfil");
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task)
                    {
                        ...
                        {
                            Toast.makeText(SettingsActivity.this, "Imagem atualizada com sucesso", Toast.LENGTH_SHORT).show();
                            ...
                            RootRef.child("Users").child(currentUserID).child("image")
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task)
                                        {
                                            if (task.isSuccessful())
                                            {
                                                Toast.makeText(SettingsActivity.this, "Imagem salva com sucesso", Toast.LENGTH_SHORT).show();
                                                loadingBar.dismiss();
                                            }
                                            else
                                            {
