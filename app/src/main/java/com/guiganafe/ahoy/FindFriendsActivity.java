...
public class FindFriendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerList = (RecyclerView) findViewById(R.id.find_friends_recycler_list);
        mRecyclerList.setLayoutManager(new LinearLayoutManager(this));

        mRecyclerList = (RecyclerView) findViewById(R.id.find_friends_recycler_list);
        mRecyclerList.setLayoutManager(new LinearLayoutManager(this));

        mToolbar = (Toolbar) findViewById(R.id.find_friends_toobar);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Contacts, FindFriendsViewHolder> adapter = new FirebaseRecyclerAdapter<Contacts, FindFriendsViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull FindFriendsViewHolder holder, final int position, @NonNull Contacts model) {
                ...
                Picasso.get().load(model.getImage()).placeholder(R.drawable.perfil).into(holder.profileImage);
